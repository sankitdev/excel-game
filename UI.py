...
if uploaded_file:
    ...
    if 'file_hash' not in st.session_state or st.session_state.file_hash != file_hash or 'processed_output' not in st.session_state:
        try:
            ...
            wb = process_attendance.process_excel(uploaded_file, progress_callback=update_progress)
